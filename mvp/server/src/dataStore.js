...
function seedData() {
  ...
  const seedMetrics = [
    ...
    },
    {
      ...
      name: 'DAU',
      domainTags: ['用户增长', '活跃度'],
      categoryPath: ['增长分析', '用户运营', '活跃度'],
      segments: ['全量用户'],
      aliases: ['Daily Active Users', '日活跃用户数'],
      owner: '刘畅',
      status: 'active',
      refreshFrequency: 'daily',
      applicability: '每日追踪整体活跃规模，用于评估产品健康度与运营波动。',
      lifecycleStage: '增长监控',
      perspective: '活跃度',
      dataOwner: '用户增长分析团队',
      templateId: 'growth-analysis',
    ...
    },
    {
      ...
      name: '新增活跃用户',
      domainTags: ['用户增长', '拉新'],
      categoryPath: ['增长分析', '用户运营', '新增留存'],
      segments: ['全量用户'],
      aliases: ['新增', 'New Active Users'],
      owner: '赵敏',
      status: 'active',
      refreshFrequency: 'daily',
      applicability: '衡量当日首次达到活跃标准的新增用户规模。',
      lifecycleStage: '增长监控',
      perspective: '拉新',
      dataOwner: '市场运营团队',
      templateId: 'growth-analysis',
    ...
    },
    {
      ...
      status: 'active',
      refreshFrequency: 'daily',
      applicability: '用于衡量从前期活跃用户中留存下来的当日活跃用户数。',
      lifecycleStage: '增长监控',
      perspective: '留存',
      dataOwner: '用户增长分析团队',
      templateId: 'growth-analysis',
    ...
    {
      id: 'returned-active-users',
      name: '回流活跃用户',
      domainTags: ['用户增长', '回流'],
      categoryPath: ['增长分析', '用户运营', '召回转化'],
      segments: ['流失用户'],
      aliases: ['回流'],
      owner: '陈峰',
      status: 'active',
      refreshFrequency: 'daily',
      applicability: '衡量沉默一段时间后再次活跃的用户贡献，用于召回策略评估。',
      lifecycleStage: '增长监控',
      perspective: '回流',
      dataOwner: '用户召回团队',
      templateId: 'growth-analysis',
    ...
    },
    {
      ...
      status: 'active',
      refreshFrequency: 'daily',
      applicability: '反映上一周期满足活跃标准的用户体量，是留存评估的基数。',
      lifecycleStage: '增长监控',
      perspective: '留存',
      dataOwner: '用户增长分析团队',
      templateId: 'growth-analysis',
    ...
    },
    {
      ...
      status: 'active',
      refreshFrequency: 'daily',
      applicability: '量化前期活跃用户在指定时间窗口内继续活跃的比例。',
      lifecycleStage: '增长监控',
      perspective: '留存',
      dataOwner: '用户增长分析团队',
      templateId: 'growth-analysis',
    ...
    },
    {
      ...
      name: '内容质量',
      domainTags: ['内容生态', '用户体验'],
      categoryPath: ['增长分析', '驱动因素', '内容体验'],
      segments: ['内容消费用户'],
      aliases: ['内容质量指数'],
      owner: '李倩',
      status: 'active',
      refreshFrequency: 'daily',
      applicability: '衡量平台内容对活跃度的支撑程度，来源于内容质量评分模型。',
      lifecycleStage: '体验反馈',
      perspective: '内容体验',
      dataOwner: '内容运营团队',
      templateId: 'experience-quality',
    ...
    },
    {
      ...
      status: 'active',
      refreshFrequency: 'daily',
      applicability: '衡量推荐系统准确匹配用户兴趣的能力，是留存率的重要驱动因素。',
      lifecycleStage: '算法迭代',
      perspective: '算法效果',
      dataOwner: '推荐算法团队',
      templateId: 'experience-quality',
    ...
    {
      id: 'user-experience-index',
      name: '用户体验指数',
      domainTags: ['用户体验', '服务质量'],
      categoryPath: ['增长分析', '驱动因素', '体验保障'],
      segments: ['全量用户'],
      aliases: ['体验指数'],
      owner: '陈峰',
      status: 'active',
      refreshFrequency: 'daily',
      applicability: '综合响应速度、稳定性、客服反馈等维度的综合体验指数。',
      lifecycleStage: '体验反馈',
      perspective: '服务体验',
      dataOwner: '用户体验团队',
      templateId: 'experience-quality',
  ...
  const versions = [
    ...
    },
    {
      ...
      metricId: 'dau',
      version: '1.0',
      definition: '每日独立活跃用户的总数，衡量产品整体用户活跃度核心指标。',
      formula: '[[新增活跃用户]] + [[留存活跃用户]] + [[回流活跃用户]]',
      source: '用户行为日志 → 活跃口径计算服务',
      refreshFrequency: 'daily',
      constraints: ['需统一设备与账号去重口径', '活跃阈值按七日滚动配置'],
      lineageNotes: '拆解为新增、留存、回流三类用户贡献。',
      createdBy: '刘畅',
      createdAt: '2024-06-30T00:00:00.000Z'
    },
    {
      id: 'new-active-users-v1-0',
      metricId: 'new-active-users',
      version: '1.0',
      definition: '当日首次满足活跃标准（如启动+关键行为）的用户数量。',
      formula: 'sum(当日首次达到活跃阈值的用户数)',
      source: '注册中心 + 行为日志',
      refreshFrequency: 'daily',
      constraints: ['需要对多端账号进行聚类去重', '排除灰度测试账号'],
      dependencies: [],
      lineageNotes: '拉新贡献，由多端注册与活跃事件交叉验证。',
      createdBy: '赵敏',
      createdAt: '2024-06-25T00:00:00.000Z'
    },
    {
      id: 'retained-active-users-v1-0',
      metricId: 'retained-active-users',
      version: '1.0',
      definition: '来自上一周期的活跃用户中，在本周期仍保持活跃的用户数。',
      formula: '[[前期活跃用户]] * [[留存率]]',
      source: '用户行为日志 → 留存分析服务',
      refreshFrequency: 'daily',
      constraints: ['留存窗口默认为7日留存，可按需求调整', '排除重复统计的多端设备'],
      lineageNotes: '依赖前期活跃用户基数与留存率测算。',
      createdBy: '王蕾',
      createdAt: '2024-06-30T00:00:00.000Z'
    },
    {
      id: 'returned-active-users-v1-0',
      metricId: 'returned-active-users',
      version: '1.0',
      definition: '在近30日未活跃但当日重新活跃的用户数量。',
      formula: 'sum(近30日未活跃且当日满足活跃阈值的用户数)',
      source: '用户行为日志 → 召回跟踪服务',
      refreshFrequency: 'daily',
      constraints: ['回流窗口默认30日，可配置', '需排除重新注册的重复账号'],
      dependencies: [],
      lineageNotes: '召回渠道追踪，衡量回流策略效果。',
      createdBy: '陈峰',
      createdAt: '2024-06-20T00:00:00.000Z'
    },
    {
      id: 'previous-active-users-v1-0',
      metricId: 'previous-active-users',
      version: '1.0',
      definition: '上一分析窗口内满足活跃标准的独立用户体量。',
      formula: 'sum(上一周期活跃用户数)',
      source: '用户行为日志 → 活跃口径计算服务',
      refreshFrequency: 'daily',
      constraints: ['周期默认7日，可根据业务定义切换', '使用与DAU一致的去重策略'],
      dependencies: [],
      lineageNotes: '作为留存评估基数，为留存活跃用户提供分母。',
      createdBy: '王蕾',
      createdAt: '2024-06-24T00:00:00.000Z'
    },
    {
      id: 'retention-rate-v1-0',
      metricId: 'retention-rate',
      version: '1.0',
      definition: '前期活跃用户在指定窗口内继续活跃的比例。',
      formula: '[[内容质量]] * [[推荐精度]] * [[用户体验指数]]',
      source: '留存分析服务 + 内容评分系统 + 推荐系统 + 体验监控',
      refreshFrequency: 'daily',
      constraints: ['各驱动因子需归一化到0-1区间', '留存窗口需与前期活跃用户保持一致'],
      lineageNotes: '模型化拆解留存率的核心驱动因素，可用于敏感度分析。',
      createdBy: '王蕾',
      createdAt: '2024-06-30T00:00:00.000Z'
    },
    {
      id: 'content-quality-score-v1-0',
      metricId: 'content-quality-score',
      version: '1.0',
      definition: '内容质量评分模型对当日内容整体表现的量化得分（0-1）。',
      formula: '内容质量模型综合得分',
      source: '内容质量模型服务',
      refreshFrequency: 'daily',
      constraints: ['需按内容类型加权，剔除低样本品类', '模型得分归一化到0-1'],
      dependencies: [],
      lineageNotes: '算法模型输出，对应内容审核与质检数据。',
      createdBy: '李倩',
      createdAt: '2024-06-28T00:00:00.000Z'
    },
    {
      id: 'recommendation-precision-v1-0',
      metricId: 'recommendation-precision',
      version: '1.0',
      definition: '推荐系统在七日滑动窗口内的端到端准确率（0-1）。',
      formula: 'sum(匹配用户兴趣的推荐点击) / sum(推荐曝光)',
      source: '推荐系统日志',
      refreshFrequency: 'daily',
      constraints: ['需过滤机器人流量', '点击事件需与推荐曝光进行一一匹配'],
      dependencies: [],
      lineageNotes: '与推荐AB实验平台打通，反映算法精度。',
      createdBy: '周诚',
      createdAt: '2024-06-28T00:00:00.000Z'
    },
    {
      id: 'user-experience-index-v1-0',
      metricId: 'user-experience-index',
      version: '1.0',
      definition: '综合加载速度、稳定性、客服满意度等维度形成的体验指数（0-1）。',
      formula: '0.4 * App稳定性得分 + 0.35 * 客服满意度指数 + 0.25 * 页面响应速度指数',
      source: '性能监控平台 + 客服满意度调查 + APM',
      refreshFrequency: 'daily',
      constraints: ['各子指标需归一化到0-1', 'APM数据需剔除探测器流量'],
      dependencies: [],
      lineageNotes: '体验团队维护的综合指数，为留存率驱动因子之一。',
      createdBy: '陈峰',
      createdAt: '2024-06-28T00:00:00.000Z'
    }
  ];
